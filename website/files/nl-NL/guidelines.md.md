...
- De korte en lange beschrijving van je bot moet gerelateerd zijn aan je bot. You are allowed to use HTML and Markdown in your bot's long description.
...
- Je bot moet de gebruiksvoorwaarden van Discord, de gebruiksvoorwaarden en het privacybeleid van de ontwikkelaar volgen.
- Je bot mag niet reageren op andere bots voor functies die zijn vergrendeld of loop-baar zijn.
...
- Je bot mag @everyone en @here niet gebruiken.
